...
This application was made to track expenses for users that are traveling. Since it's completely functional offline and online.

## Screenshots

This screenshot shows the post request failing and then bulk sending once online
![Screenshot](/public/screenshots/offline.PNG)
This screenshot shows the data store while offline
![Screenshot](/public/screenshots/cache.PNG)
